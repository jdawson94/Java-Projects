...
public class DepositAccount extends Account {
    ...
    public DepositAccount(String accountNumber, String accountHolder, int interest) {
    ...
    void display() {
        ...
        System.out.print (String.format (formatString, "Deposit Account", this.getAccountNumber (),
